function VariantFilterWidget(jobId,args){
	...
	wumAdapter.onPoll.addEventListener(function(sender,data){
...
//		model:modelName
	...
	var grid = Ext.create('Ext.grid.Panel', {
        ...
        cls:'panel-border-left',
		flex:3,
		dockedItems: [{xtype: 'pagingtoolbar',store: store, dock: 'top', displayInfo: true,
