...
public class GeneralCliOptions {
    ...
    public static class JobOptions {
        @Parameter(names = {"--job-id"}, description = "Job ID. It must be a unique string within the study. An ID will be "
                + "autogenerated automatically if not provided.", arity = 1)
        public String jobId;
