...
package org.opencb.commons.api.writers.cli;

import org.apache.commons.collections4.CollectionUtils;
import org.apache.commons.lang3.StringUtils;
import org.opencb.commons.annotations.RestParamType;
import org.opencb.commons.api.config.CategoryConfig;
import org.opencb.commons.api.config.Command;
import org.opencb.commons.api.config.CommandLineConfiguration;
...
//                                    javaValue = CommandLineUtils.getAsVariableName(getJavaClassName(bodyParam));
    ...
    private String getQueryParams(RestEndpoint restEndpoint, CategoryConfig config, String commandName) {
        ...
        if (enc) {
            if (studyPresent) {
                res.append("        if (queryParams.get(\"study\") == null && OpencgaCommandLine.isShellMode()) {\n");
